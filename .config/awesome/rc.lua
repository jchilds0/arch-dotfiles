...
globalkeys = gears.table.join(
    ...
    awful.key({  }, "XF86MonBrightnessUp", function()
              awful.util.spawn("brightnessctl s 25+") end,
    ...
    awful.key({  }, "XF86AudioRaiseVolume", function()
              awful.util.spawn("amixer sset Master 10%+", false) end,
              {description = "audio up", group = "client"}),
    awful.key({  }, "XF86AudioLowerVolume", function()
              awful.util.spawn("amixer sset Master 10%-", false) end,
              {description = "audio down", group = "client"}),
    awful.key({  }, "XF86AudioMute", function()
              awful.util.spawn("amixer set Master mute", false) end,
              {description = "audio mute", group = "client"})
)
